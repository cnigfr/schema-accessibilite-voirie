...
COLUMN_SPECS: dict[tuple[str, str], tuple[str | None, str]] = {
    ...
    ("traversee", "typeTroncon"):    ("type_troncon",     "type de tronçon"),
    ...
    ("rampe", "typeTroncon"):     ("type_troncon",     "type de tronçon"),
    ...
    ("escalier", "typeTroncon"):          ("type_troncon","type de tronçon"),
    ...
    ("escalator", "typeTroncon"):         ("type_troncon","type de tronçon"),
    ...
    ("tapis_roulant", "typeTroncon"):         ("type_troncon","type de tronçon"),
    ...
    ("quai", "typeTroncon"):         ("type_troncon",            "type de tronçon"),
    ...
    ("ascenseur", "diamManoeuvreFauteuil"): (None,                     "diamètre de la zone de manœuvre devant l'ascenseur en mètres"),
