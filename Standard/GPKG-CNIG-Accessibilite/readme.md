# GeoPackage CNIG Accessibilité

Le **GeoPackage CNIG Accessibilité** est un format d’échange de données conforme au [standard CNIG Accessibilité du cheminement en voirie](https://cnig.gouv.fr/IMG/pdf/250314_standard_cnig_accessibilite_v2021-10_rev2025-03-2.pdf).
...
Les identifiants CNIG sont générés automatiquement à l'insertion d'un objet s'ils ne sont pas déjà renseignés.

Le format généré est standardisé : `{CodeClasse}:{fid}:LOC`
...
Le module est utilisable en Python et en ligne de commande, via la CLI `gpkg-cnig` ou directement via Alembic.
...
## Alembic — gestion avancée des versions
...
# Actualisations et contributions
